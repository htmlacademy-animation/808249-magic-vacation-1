...
class FullPageScroll {
  ...
  changeVisibilityDisplay() {
    let isStoryScreen = false;

    this.screenElements.forEach((screen) => {
      if (screen.id === `story` && screen.classList.contains(`active`)) {
        isStoryScreen = true;
        screen.classList.remove(`active`);
        screen.classList.add(`screen--filling`);

        setTimeout(() => {
          screen.classList.add(`screen--hidden`);
          screen.classList.remove(`screen--filling`);
...
/* harmony import */ var _modules_wrap_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./modules/wrap.js */ "./source/js/modules/wrap.js");
// modules
...
const animationIntroTitle = new _modules_wrap_js__WEBPACK_IMPORTED_MODULE_10__["default"]({
  elementSelector: `.intro__title`,
  hasSeveraLines: true,
});
const animationDate = new _modules_wrap_js__WEBPACK_IMPORTED_MODULE_10__["default"]({elementSelector: `.intro__date`, delay: 700});
const animationStoryTitle = new _modules_wrap_js__WEBPACK_IMPORTED_MODULE_10__["default"]({
  elementSelector: `.slider__item-title`,
});
const animationPrizesTitle = new _modules_wrap_js__WEBPACK_IMPORTED_MODULE_10__["default"]({elementSelector: `.prizes__title`});
